...
from poll.views import TypeView
from django.core.urlresolvers import reverse
from django.test import TestCase
from django.utils import timezone
from poll.models import Choice,QuestionType
...
class HomePageTest(TestCase):
	...
	def test_root_url_resolves_to_home_page_view(self):
		found = resolve('/')
		self.assertEqual(found.func.func_name,TypeView.__name__)		

#     def test_root_url_shows_links_to_all_polls(self):
#         # set up some polls
#         p = QuestionType(question='6 times 7')
#         p.save()
...
#         # check we've passed the polls to the template
        #polls_in_context = response.context['type_list']
        #self.assertEquals(list(polls_in_context), [p])
